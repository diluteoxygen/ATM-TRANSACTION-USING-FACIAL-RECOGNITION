...
class BankUi: #main UI
    def __init__(self, root):
        self.root = root
        self.header = Label(self.root, text="VIT BANK", bg="#4F66E7", fg="white", font=("arial", 20, "bold"))
        self.header.pack(fill=X)
        self.frame = Frame(self.root, bg="#4F66E7", width=900, height=500)
        root.geometry("800x500")
        self.button1 = Button(self.frame, text="Click to begin transactions", bg="#4BE7F1", fg="white", font=ARIAL,
                              command=self.begin_page)
        self.q = Button(self.frame, text="Quit", bg="#4BE7F1", fg="white", font=ARIAL, command=self.root.destroy)
    ...
    def begin_page(self):
        ...
        self.frame = Frame(self.root, bg="#4F66E7", width=900, height=500)
        root.geometry("800x500")
        self.enroll = Button(self.frame, text="Enroll", bg="#4BE7F1", fg="white", font=ARIAL, command=self.enroll_user)
        self.withdraw = Button(self.frame, text="Withdraw Money", bg="#4BE7F1", fg="white", font=ARIAL,
    ...
    def withdraw_money_page(self):
        ...
        self.label6 = Label(self.frame,
                            ...
                            bg="#4F66E7", fg="white", font=ARIAL)
        self.label7 = Label(self.frame, text="6.To begin, click the 'Verify Face Id' button below", bg="#4F66E7",
                            fg="white", font=ARIAL)
        self.button = Button(self.frame, text="Verify Face Id", bg="#4BE7F1", fg="white", font=ARIAL,
                             command=self.video_check)
        self.q = Button(self.frame, text="Quit", bg="#4BE7F1", fg="white", font=ARIAL, command=self.root.destroy)
        self.b = Button(self.frame, text="Back", bg="#4BE7F1", fg="white", font=ARIAL, command=self.begin_page)
        self.label1.place(x=40, y=100, width=800, height=20)
        self.label2.place(x=10, y=120, width=800, height=20)
        self.label3.place(x=10, y=150, width=800, height=20)
        self.label4.place(x=10, y=180, width=800, height=20)
        self.label5.place(x=10, y=200, width=800, height=20)
        self.label6.place(x=10, y=220, width=800, height=20)
        self.label7.place(x=10, y=240, width=800, height=20)
        self.button.place(x=380, y=280, width=120, height=30)
    ...
    def enroll_user(self):
        ...
        self.frame = Frame(self.root, bg="#4F66E7", width=900, height=500)
        # Login Page Form Components
        self.userlabel = Label(self.frame, text="Full Name", bg="#4F66E7", fg="white", font=ARIAL)
        self.uentry = Entry(self.frame, bg="honeydew", highlightcolor="#4BE7F1",
                            highlightthickness=2,
                            highlightbackground="white")
        self.plabel = Label(self.frame, text="Password", bg="#4F66E7", fg="white", font=ARIAL)
        self.pentry = Entry(self.frame, bg="honeydew", show="*", highlightcolor="#4BE7F1",
                            highlightthickness=2,
                            highlightbackground="white")
        self.button1 = Button(self.frame, text="Next", bg="#4BE7F1", fg="white", font=ARIAL,
                              command=self.enroll_and_move_to_next_screen)
        # self.button2 = Button(self.frame,text="Click to go to video capture after enrolling",bg="#4BE7F1",fg="white",font=ARIAL, command = self.video_page)
        self.q = Button(self.frame, text="Quit", bg="#4BE7F1", fg="white", font=ARIAL, command=self.root.destroy)
        self.b = Button(self.frame, text="Back", bg="#4BE7F1", fg="white", font=ARIAL, command=self.begin_page)
    ...
    def password_verification(self):
        ...
        # Login Page Form Components
        self.plabel = Label(self.frame, text="Please enter your account password ", bg="#4F66E7", fg="white", font=ARIAL)
        self.givenpentry = Entry(self.frame, bg="honeydew", show="*", highlightcolor="#4BE7F1",
                                 highlightthickness=2,
                                 highlightbackground="white")
        self.button1 = Button(self.frame, text="Verify", bg="#4BE7F1", fg="white", font=ARIAL, command=self.verify_user)
        self.q = Button(self.frame, text="Quit", bg="#4BE7F1", fg="white", font=ARIAL, command=self.root.destroy)
        self.b = Button(self.frame, text="Back", bg="#4BE7F1", fg="white", font=ARIAL, command=self.begin_page)
        self.plabel.place(x=125, y=160, width=300, height=20)
        self.plabel.place(x=140, y=160, width=300, height=20)
    ...
    def final_page(self):
        self.frame.destroy()
        self.frame = Frame(self.root, bg="#4F66E7", width=900, height=500)
        self.detail = Button(self.frame, text="Transfer", bg="#4BE7F1", fg="white", font=ARIAL,
                             command=self.user_account_transfer)
        self.enquiry = Button(self.frame, text="Balance Enquiry", bg="#4BE7F1", fg="white", font=ARIAL,
                              command=self.user_balance)
        self.deposit = Button(self.frame, text="Deposit Money", bg="#4BE7F1", fg="white", font=ARIAL,
                              command=self.user_deposit_money)
        self.withdrawl = Button(self.frame, text="Withdrawl Money", bg="#4BE7F1", fg="white", font=ARIAL,
                                command=self.user_withdrawl_money)
        self.q = Button(self.frame, text="Log out", bg="#4BE7F1", fg="white", font=ARIAL, command=self.begin_page)
    ...
    def user_account_transfer(self):
        ...
        self.q.place(x=340, y=340, width=120, height=20)
        self.frame.pack()
        self.label11 = Label(self.frame, text="Please enter the reciepient's account number", bg="#4F66E7", fg="white",
                             font=ARIAL)
        self.label21 = Label(self.frame, text="Please enter the amount to be transferred", bg="#4F66E7", fg="white",
                             font=ARIAL)
        self.button1 = Button(self.frame, text="Transfer", bg="#4BE7F1", fg="white", font=ARIAL,
                              command=self.user_account_transfer_transc)
        self.entry11 = Entry(self.frame, bg="honeydew", highlightcolor="#4BE7F1",
                             highlightthickness=2,
                             highlightbackground="white")
        self.entry21 = Entry(self.frame, bg="honeydew", highlightcolor="#4BE7F1",
                             highlightthickness=2,
                             highlightbackground="white")
    ...
    def user_deposit_money(self):
        ...
        self.label.place(x=200, y=100, width=300, height=100)
        self.money_box = Entry(self.frame, bg="honeydew", highlightcolor="#4BE7F1",
                               highlightthickness=2,
                               highlightbackground="white")
        self.submitButton = Button(self.frame, text="Deposit", bg="#4BE7F1", fg="white", font=ARIAL)
    ...
    def user_withdrawl_money(self):
        ...
        self.money_box = Entry(self.frame, bg="honeydew", highlightcolor="#4BE7F1",
                               highlightthickness=2,
                               highlightbackground="white")
        self.submitButton = Button(self.frame, text="Withdraw", bg="#4BE7F1", fg="white", font=ARIAL)
    ...
    def write_to_csv(self):
        ...
        messagebox._show("Enrollment Info!", "Successfully Enrolled with an account no= "+ str(unique_id))
    ...
    def video_capture_page(self):
        ...
        self.label6 = Label(self.frame,
                            ...
                            bg="#4F66E7", fg="white", font=ARIAL)
        self.button = Button(self.frame, text="Capture", bg="#4BE7F1", fg="white", font=ARIAL, command=self.captureuser)
        # self.q = Button(self.frame,text="Quit",bg="#4BE7F1",fg="white",font=ARIAL,command = self.root.destroy)
        # self.b = Button(self.frame,text="Back",bg="#4BE7F1",fg="white",font=ARIAL,command = self.enroll_user)
    ...
    def captureuser(self):
        ...
        # self.get_embeddings()
        self.train_model()
        messagebox._show("Registration Info!", "Successfully Registered ")
        self.begin_page()
    ...
    def video_check(self):
        ...
        while True:
            ...
            for i in range(0, detections.shape[2]):
                ...
                if confidence > 0.5:
                    ...
                    j = np.argmax(preds)
                    proba = preds[j]
                    recognized_name = le.classes_[j]

                    # TODO: Handle if 2 faces are given.
                    # Decision boundary
                    if recognized_name == name and proba * 100 >= 10:
                        real_user_list.append(recognized_name)
                    else:
                        print("Face not recognized or does not match the entered name/ID")
        ...
        try:
            ...
            if Counter(real_user_list).most_common(1)[0][0] == 'unknown':
                ...
                messagebox._show("Verification Info!", "Face Id matched with account no" +str(self.real_user))
